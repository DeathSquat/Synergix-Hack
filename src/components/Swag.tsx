          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 border border-white/20">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-gray-300 border border-white/30 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                maxLength={30}
              />
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 border border-white/20">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-700 text-white rounded-lg transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
              >
            ...
            <button
              ...
              className="w-full py-3 sm:py-4 bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-700 hover:to-orange-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-bold text-base sm:text-lg rounded-2xl transition-all transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed"
            >
              {isGenerating ? (
          ...
          <div className="flex flex-col items-center mt-8 lg:mt-0">
            ...
            {participantName && uploadedImage && (
              <button
                ...
                className="mt-5 sm:mt-6 px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-xl transition-all transform hover:scale-105 flex items-center gap-2 text-sm sm:text-base"
              >
